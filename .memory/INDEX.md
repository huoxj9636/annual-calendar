...
| 2026-06-30 | 记忆系统-结构总览 | 确认AGENTS.md/.memory//cross-session-memory/三层结构，规则变更触发条件位置 | sessions/2026-06-30-周复盘时间轴.md#Q17(L185) |
| 2026-06-30 | 记忆系统-提示词分版 | 同项目追加（读AGENTS.md启动规则）vs 新项目初始化（加载技能包），两句话即可 | sessions/2026-06-30-周复盘时间轴.md#Q18(L198) |
| 2026-06-30 | 记忆系统-技能包自足 | 技能包已含全部细节，提示词无需重复抄写，Agent读技能包即可执行 | sessions/2026-06-30-周复盘时间轴.md#Q19(L210) |
