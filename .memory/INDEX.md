...
| 2026-07-01 | 记忆系统-结构总览 | 确认AGENTS.md/.memory//cross-session-memory/三层结构，规则变更触发条件位置 | sessions/2026-07-01-记忆系统规则修正.md#Q1(L10) |
| 2026-07-01 | 记忆系统-提示词分版 | 同项目追加（读AGENTS.md启动规则）vs 新项目初始化（加载技能包），两句话即可 | sessions/2026-07-01-记忆系统规则修正.md#Q1(L10) |
| 2026-07-01 | 记忆系统-技能包自足 | 技能包已含全部细节，提示词无需重复抄写，Agent读技能包即可执行 | sessions/2026-07-01-记忆系统规则修正.md#Q1(L10) |
| 2026-07-01 | 记忆系统-session独立规则 | session文件每个对话独立，绝不追加到旧文件；INDEX/PITFALL才追加 | sessions/2026-07-01-记忆系统规则修正.md#Q1(L10) |
