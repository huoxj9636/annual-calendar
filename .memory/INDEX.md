...
| 2026-07-12 | 自定义链接-刷新消失 | 模块顺序加载过滤allKeys仅内建8个,bm_xxx被过滤;扩展为validKeySet=内建+书签ID | sessions/2026-07-12-自定义链接消失.md#A1(L23) |
| 2026-07-12 | 复盘弹框-盖住头图 | 弹框1320x820/90vh过大盖住顶部年历头图,缩小为2/3=880x547/60vh,头图露出 | sessions/2026-07-12-自定义链接消失.md#A2(L91) |
| 2026-07-12 | 复盘弹框-二次调大 | 880x547太小,调整为1280x700/75vh,头图仍完整露出 | sessions/2026-07-12-自定义链接消失.md#A3(L126) |
