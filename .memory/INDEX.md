...
| 2026-07-12 | 自定义链接-刷新消失 | 模块顺序加载过滤allKeys仅内建8个,bm_xxx被过滤;扩展为validKeySet=内建+书签ID | sessions/2026-07-12-自定义链接消失.md#A1(L25) |
| 2026-07-12 | 复盘弹框-盖住头图 | 弹框1320x820/90vh过大盖住顶部年历头图,缩小为2/3=880x547/60vh,头图露出 | sessions/2026-07-12-自定义链接消失.md#A2(L93) |
| 2026-07-12 | 复盘弹框-二次调大 | 880x547太小,调整为1280x700/75vh,头图仍完整露出 | sessions/2026-07-12-自定义链接消失.md#A3(L128) |
| 2026-07-12 | 甘特图刻度-尺子效果 | 刻度线cellBorder(10%淡)改textMuted,底部加2px横杠基线,小时刻度2px宽/10px高 | sessions/2026-07-12-自定义链接消失.md#A4(L184) |
| 2026-07-01 | 甘特图刻度-尺子效果修正 | 横杠改顶部(border-t+top-0),竖线从上往下凸;事项行恢复淡色网格线 | sessions/2026-07-12-自定义链接消失.md#A5(L160) |
| 2026-07-01 | 事项文字+刻度颜色调浅 | 事项占位符textPrimary→textMuted;尺子横杠80%→60%,竖线0.9→0.6/0.5→0.35 | sessions/2026-07-12-自定义链接消失.md#A6(L159) |
