    ...
    <>
      ...
      <div style={sceneStyle} className="w-full">
        ...
        >
          {/* 最远山 */}
          <path
            d="M0,180 L60,140 L120,160 L180,110 L240,140 L300,100 L360,130 L420,90 L480,120 L540,85 L600,115 L660,95 L720,130 L780,100 L840,135 L900,110 L960,140 L1000,125 L1000,220 L0,220 Z"
            fill={skin.swatch}
            opacity={0.14}
          />
          {/* 中山 */}
          <path
            d="M0,200 L80,160 L160,180 L240,140 L320,170 L400,135 L480,165 L560,130 L640,160 L720,140 L800,170 L880,145 L960,175 L1000,160 L1000,220 L0,220 Z"
            fill={skin.swatch}
            opacity={0.22}
          />
          {/* 近山 */}
          <path
            d="M0,210 L60,190 L140,200 L220,180 L300,195 L380,175 L460,195 L540,180 L620,200 L700,185 L780,205 L860,185 L940,200 L1000,190 L1000,220 L0,220 Z"
            fill={skin.swatch}
            opacity={0.32}
          />
        </svg>
