...
export default function LifeCalendar({ birthYear, setBirthYear, onClose, skinKey }: LifeCalendarProps) {
  ...
  return (
    <div ref={containerRef} className="fixed top-0 left-0 z-50 h-full animate-slide-in-left shadow-2xl flex flex-col transition-colors duration-500"
      ...
      <div className="flex-shrink-0 px-5 pt-10 pb-4 relative overflow-hidden" style={skin.headerBgImage ? { backgroundImage: `url(${skin.headerBgImage})`, backgroundSize: "cover", backgroundPosition: "center" } : { background: `linear-gradient(135deg, ${skin.headerFrom} 0%, ${skin.headerTo} 100%)` }}>
