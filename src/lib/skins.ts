...
export const SKINS: SkinTheme[] = [
  {
    ...
    pastBg: 'rgba(210,215,225,0.55)',
    pastWeekendBg: 'rgba(200,208,218,0.6)',
    pastText: '#bfbfbf',
    pastSubtext: '#d0d0d0',
    checkColor: '#10b981',
    crossColor: '#ef4444',
  ...
  },
  {
    ...
    todayRing: '#60a5fa',
    cellBorder: 'rgba(100,116,139,0.18)',
    pastBg: 'rgba(15,23,42,0.65)',
    pastWeekendBg: 'rgba(15,23,42,0.72)',
    pastText: '#64748b',
    pastSubtext: '#475569',
    checkColor: '#34d399',
    crossColor: '#f87171',
...
/** 默认无皮肤 - 原始外观 */
export const NO_SKIN: SkinTheme = {
  key: '',
  label: '默认',
  labelEn: 'Default',
  slogan: '',
  ...
  divider: '#e2e8f0',
  stageColors: [
    { color: '#e2e8f0', accent: '#475569', bg: '#f8fafc', border: '#cbd5e1' },
    { color: '#e2e8f0', accent: '#475569', bg: '#f8fafc', border: '#cbd5e1' },
    { color: '#e2e8f0', accent: '#475569', bg: '#f8fafc', border: '#cbd5e1' },
    { color: '#e2e8f0', accent: '#475569', bg: '#f8fafc', border: '#cbd5e1' },
    { color: '#e2e8f0', accent: '#475569', bg: '#f8fafc', border: '#cbd5e1' },
  ...
  sidebarTo: '#f1f5f9',
  headerBgImage: '',
  headerBgOverlay: 'linear-gradient(180deg, rgba(255,255,255,0.0) 0%, rgba(255,255,255,0.0) 100%)',
  isDark: false,
};
